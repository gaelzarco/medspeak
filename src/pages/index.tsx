  ...
  return (
    <main className="flex flex-col min-h-full w-full max-w-7xl p-5">
      ...
      <div className="flex justify-between w-[95%] mx-auto">
        <motion.button
          className="flex flex-col justify-between text-left border border-neutral-700 min-w-[150px] w-[49%] p-5 rounded-xl"
        ...
        >
          ...
          <div>
            ...
            <p className="leading-10 text-sm text-neutral-400">
              This is where you can create a document and try MedSpeak for
              yourself.
            </p>
          </div>
        </motion.button>
        ...
        >
          ...
          <div>
            ...
            <p className="leading-10 text-sm text-neutral-400">
              We'd love to hear how we can improve MedSpeak to fit your needs.
            </p>
          </div>
        </motion.button>
      </div>
      ...
      <div className="mt-4 w-full p-5">
        ...
        <p className="leading-10 text-sm text-neutral-400">Nothing yet...</p>
      </div>
    </main>
  );
}
