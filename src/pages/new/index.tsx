...
export default function NewDoc() {
  ...
  return (
    <motion.div
      ref={parent}
      className="flex flex-col w-full max-w-7xl p-5"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <div className="w-full rounded-xl p-5">
        ...
        <p className="text-sm mt-2 text-neutral-400">
          Here is where your journey begins. Provide an audio file of your
          conversation with patients and let MedSpeak handle the rest. We create
          a transcript of your conversation and highlight important medical
          information so you don't have to. Afterwards, you can review and save.
        </p>
      </div>
      ...
      {!transcript && !loading && (
        <form
          className="flex flex-col justify-between w-full mt-8 border border-neutral-700 rounded-xl p-5"
        ...
        >
          ...
          <div className="flex flex-col w-full px-2 mb-4 mt-5">
            <label className=" text-lg font-semibold" htmlFor="audio">
              Upload Audio
            </label>
            <p className="text-sm mt-2 text-neutral-400">
              Provide an .mp3 or .wav file and let MedSpeak handle the rest. We
              use OpenAI's Whisper API to create a transcript of the
              conversation between you and your partient.{" "}
            </p>
          </div>
