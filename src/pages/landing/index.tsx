            ...
            <div className="inline-flex w-full h-screen">
                <div className="flex flex-col h-full w-full">
                    ...
                    <div className="flex flex-col w-3/4 m-auto pr-8">
                        <h1 className="text-3xl font-semibold">Steamline patient and staff communication.</h1>
                        <h1 className="mt-5">
                ...
                <div className='flex flex-col w-full'>
                    <video className="w-full h-full object-cover" autoPlay loop muted disablePictureInPicture>
